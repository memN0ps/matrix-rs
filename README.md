...
Special thanks to [Daax Rynd (@daax_rynd), Aidan Khoury (@ajkhoury), Nick Peterson (@everdox)](https://revers.engineering/7-days-to-virtualization-a-series-on-hypervisor-development/), [Carl Schou (@vmcall)](https://github.com/vmcall), [Satoshi Tanda (@standa_t)](https://github.com/tandasat/Hypervisor-101-in-Rust), [Drew (@drewbervisor)](https://github.com/drew-gpf), [Sina Karvandi (@Intel80x86)](https://github.com/SinaKarvandi/Hypervisor-From-Scratch/), and [Matthias (@not_matthias)](https://github.com/not-matthias/amd_hypervisor) for their help, awesome blogs, and code.
