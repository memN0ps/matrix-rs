use x86::{cpuid::CpuId, msr::{rdmsr, IA32_FEATURE_CONTROL, IA32_VMX_CR0_FIXED0, IA32_VMX_CR0_FIXED1, IA32_VMX_CR4_FIXED0, IA32_VMX_CR4_FIXED1, IA32_VMX_BASIC, wrmsr}, current::vmx::vmxon, controlregs::{Cr4, cr4, cr4_write, cr0, Cr0}};
...
impl VMX {
    ...
    /// Enables Virtual Machine Extensions (CR4.VMXE\[bit 13] = 1).
    ...
    /// Get the Virtual Machine Control Structure Identifier (VMCS ID)
    ...
    */
    ...
    pub fn allocate_vmm_context(&self) {    
